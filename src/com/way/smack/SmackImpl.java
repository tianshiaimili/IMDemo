...
public class SmackImpl implements Smack {
	...
	public SmackImpl(XXService service) {
		...
		LogUtils2.i("customServer = "+customServer);
		LogUtils2.i("port = "+port);
		LogUtils2.i("server = "+server);
		LogUtils2.i("smackdebug = "+smackdebug);
		LogUtils2.i("requireSsl = "+requireSsl);
		...
		LogUtils2.i("******is can connection success = "+mXMPPConnection);
	...
	public boolean login(String account, String password) throws XXException {
		LogUtils2.i("*****do the login in SmackImpl******");
		try {
...
//				mXMPPConnection.login(account, password, ressource);
				LogUtils2.i("account = "+account+" , "+"password = "+password+" , ressource = "+ressource );
