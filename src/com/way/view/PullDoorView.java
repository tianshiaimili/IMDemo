...
//		DisplayMetrics displayMetrics = mContext.getResources().getDisplayMetrics();
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			LogUtils2.e("MotionEvent.ACTION_DOWN :mLastDownY== "+mLastDownY);
		...
		case MotionEvent.ACTION_MOVE:
			...
			LogUtils2.e("mCurryY== "+mCurryY);
			LogUtils2.e("MotionEvent.ACTION_MOVE :mLastDownY== "+mLastDownY);
			LogUtils2.e("mDelY== "+mDelY);
			// 只准上滑有效
			if (mDelY < 0) {
				//滑动过程中需要不停的调用这里绘画
				scrollTo(0, -mDelY);
